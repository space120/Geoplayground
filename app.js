...
// Bubble grid (hex lattice circles) + snap dot + pan/zoom + line drawing + erase + basic save/load/png
...
// Circle grid params (world units)
const BASE_R = 40;
...
function drawLines() {
  ...
  state.lines.forEach((ln, i) => {
    ...
    ctx.strokeStyle = selected ? '#ffe36a' : '#ffffff';
...
function setTool(name) {
  ...
  // cancel in-progress line if switching away
